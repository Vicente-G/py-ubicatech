...
from src.app.utils.custom_errors import CouldNotVerifyLogin
...
def test_register_service_reject_duplicates(client, db, user_details):
    ...
    assert response_duplicate.status_code == CONFLICT_CODE
...
def test_login_success(client, existing_user, user_details):
    ...
    assert login_view_response.status_code == SUCCESS_CODE
